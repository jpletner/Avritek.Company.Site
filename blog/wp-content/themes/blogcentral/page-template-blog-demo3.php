<?php
/**
 * Template name: Blog Demo 3
 *
 * Demo 3 of the blog. Only for demo purposes, can safely be deleted.
 *
 * @since BlogCentral 1.0.0
 *
 * @package BlogCentral
 * @subpackage page-template-blog-demo3.php
 */
...
$page_header_title = __( 'Demo 3', BLOGCENTRAL_TXT_DOMAIN );
