<?php
/**
 * Template name: Blog Demo 1
 *
 * Demo 1 of the blog. Only for demo purposes, can safely be deleted.
 *
 * @since BlogCentral 1.0.0
 *
 * @package BlogCentral
 * @subpackage page-template-blog-demo1.php
 */
...
$page_header_title = __( 'Demo 1', BLOGCENTRAL_TXT_DOMAIN );
...
<div id="main-content"<?php echo $main_class; ?>>
	...
	</div><!-- End #main-area --><?php //no space here or will break layout
