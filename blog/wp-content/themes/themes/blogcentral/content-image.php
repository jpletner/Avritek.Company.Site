<?php 
/** 
 * Template for post image format content
 *
...
$blogcentral_layout_opts['layout'] = isset( $blogcentral_layout_opts['layout'] ) ? $blogcentral_layout_opts['layout'] : 'layout1';
...
if ( isset( $blogcentral_layout_opts['layout'] ) && 'layout3' !== $blogcentral_layout_opts['layout'] ) {
	...
	if ( ! empty( $blogcentral_layout_opts['display_format_icon'] ) && ! empty( $blogcentral_layout_opts['image_icon'] ) ) {
		$blogcentral_post_format_icon = '<i class="post-format-icon fa ' . esc_attr( $blogcentral_layout_opts['image_icon'] ) . '"></i>';
	}
}
